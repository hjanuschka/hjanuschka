...
**Head of Engineering** at [krone.at](https://krone.at) | Vienna, Austria

Contributing to browser engines, compilers, and open source tooling.
...
**Chromium**
- `--focus` flag - Focuses existing tabs instead of opening duplicates (Chrome 143)
- Wayland crash fix for multi-monitor setups
...
- [Website & Blog](https://januschka.com)
- [2025 Chromium Contributions](https://januschka.com/2025-chromium-contributions.html)
- [JPEG XL Returns to Chrome](https://januschka.com/chromium-jxl-resurrection.html)

---

<sub>*Also: CEO & CTO at [Captcha.eu](https://captcha.eu)*</sub>
